  ...
  return (
    <section className="py-20 bg-bg-primary transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-linear-to-r from-bg-secondary to-bg-primary rounded-3xl p-8 md:p-12 shadow-2xl relative overflow-hidden border border-border-color">
            ...
            <div className="w-full md:w-1/3 flex justify-center">
              <div className="relative w-64 h-64 md:w-72 md:h-72">
                ...
                <img 
                  ...
                  alt="Andi Saputra - Head Mentor Inba University, Certified Financial Technician" 
            ...
            <div className="w-full md:w-2/3 text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start gap-4">
                 <a 
                   ...
                   aria-label="Follow Inba University on Instagram"
                   className="flex items-center gap-2 px-5 py-2.5 bg-bg-secondary border border-border-color rounded-lg text-text-primary hover:border-brand-emerald hover:text-brand-emerald transition-all shadow-sm focus:ring-2 focus:ring-brand-emerald focus:ring-offset-2"
                 >
                    <Instagram className="w-5 h-5" />
                    <span>@inbauniversity</span>
                 </a>
                 <a 
                   href="https://www.youtube.com/@inbauniversity" 
                   target="_blank" 
                   rel="noopener noreferrer"
                   aria-label="Subscribe to Inba University on YouTube"
                   className="flex items-center gap-2 px-5 py-2.5 bg-bg-secondary border border-border-color rounded-lg text-text-primary hover:border-red-500 hover:text-red-500 transition-all shadow-sm focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
                 >
